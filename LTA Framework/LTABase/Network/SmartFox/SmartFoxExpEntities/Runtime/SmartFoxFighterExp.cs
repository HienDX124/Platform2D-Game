...
public class SmartFoxFighterExp : SmartFoxEntities
{
    public SmartFoxFighterExp(string listEntitiesName) : base(listEntitiesName)
    {
    ...
    public override void OnResponse(ISFSObject data)
    {
        ...
        //                PackItemExp packItem = new PackItemExp(item_.GetUtfString("EquipmentId"),0,item_.GetUtfString("EntityName"), item_.GetInt("level"));
        //                pack.Add(packItem);
        //            }
        //        }
        //    }
            
        //    PackExpFighterEntity packExpFighter =  AddEntity(item.GetUtfString("fighterId"),item.GetUtfString("EntityName"), item.GetInt("level"), item.GetInt("exp"),item.GetInt("price"), pack.ToArray());
    ...
    //private PackExpFighterEntity AddEntity(string id, string entityName, int level, int exp,int price, PackItem[] items)
    //{
